...
\begin{figure}[!hbp] % Credit to stack exchange user Masroor and user Stefan Kottwitz for the implementation of side by side figures in LaTeX
    ...
    \begin{minipage}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{bc-l-ms.png}
        \includegraphics[width=\textwidth]{bc-l-ds.png}
    ...
    \hfill
    \begin{minipage}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{bc-p-ms.png}
        \includegraphics[width=\textwidth]{bc-l-ds.png}
    ...
    \hfill
    \begin{minipage}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{bc-r-ms.png}
        \includegraphics[width=\textwidth]{bc-r-ds.png}
